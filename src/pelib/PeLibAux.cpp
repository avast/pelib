...
namespace PeLib
{
	...
	static const LoaderErrorString LdrErrStrings[] =
	{
		...
		{"LDR_ERROR_SECTION_ALIGNMENT_INVALID",    "IMAGE_OPTIONAL_HEADER::SectionAlignment must be equal to IMAGE_OPTIONAL_HEADER::FileAlignment if (FileAlignment < SECTOR_SIZE)" },
